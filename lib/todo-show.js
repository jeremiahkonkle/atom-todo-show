...
class TodoShow {
  ...
  activate() {
    ...
    this.disposables.add(atom.commands.add('atom-workspace', {
      ...
      'todo-show:select': () => this.selectView().toggle()
    }))
  ...
  selectView(event) {
    if (!this._selectView) {
      const SelectView  = require('./todo-select-view');
      this._selectView = new SelectView(this.collection);
    }
